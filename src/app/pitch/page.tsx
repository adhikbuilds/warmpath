  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-6 max-w-3xl">
        ...
        >
          Close deals through the people
          <br />
        ...
        >
          AI-first relationship intelligence that finds warm intro paths, drafts personalized
          outreach, and routes every message through your team's trusted network.
        </p>
...
function SlideProblem() {
  const stats = [
    ...
    {
      number: "67%",
      label: "Of sales time wasted on bad-fit prospects",
      sub: "Gartner Sales Report",
    },
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          Cold outreach is
          <br />
          <span style={{ color: C.primaryLight }}>fundamentally broken</span>
        </h2>
        ...
        <div className="grid grid-cols-3 gap-6 mb-12">
          {stats.map((s) => (
            <div
              ...
              style={{ backgroundColor: C.darkElevated, border: `1px solid #ffffff0d` }}
            >
              <div
                style={{
                  fontFamily: SERIF,
        ...
        <div
          ...
          style={{ backgroundColor: `${C.primary}15`, border: `1px solid ${C.primary}30` }}
        >
          <p style={{ fontFamily: SANS, fontSize: 17, color: C.onDark, lineHeight: 1.7 }}>
            <span style={{ color: C.primaryLight, fontWeight: 600 }}>
              The root cause isn't messaging — it's trust.
            </span>{" "}
            Buyers ignore strangers, no matter how good the copy. The top 1% of sales reps already
            know this: they only reach out through people the buyer already trusts. Everyone else
            guesses.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div
            ...
            style={{ backgroundColor: C.dark, minHeight: 300, padding: 32 }}
          >
            <svg width="100%" viewBox="0 0 400 260" style={{ maxWidth: 380 }}>
              ...
              {/* Warm path - orange */}
              <path
                d="M 60 130 Q 130 60 200 90 Q 270 120 340 130"
                fill="none"
                stroke={C.primary}
                strokeWidth="2.5"
              />
            ...
            {[
              {
                ...
                desc: "Maps connections across your entire team — LinkedIn, email, Salesforce, calendar.",
              },
              {
                icon: Zap,
                title: "AI warm path finder",
                desc: "BFS pathfinding ranks every intro route by warmth score, recency, and relationship strength.",
              },
              {
                icon: CheckCircle,
                title: "Human approval queue",
                desc: "Every message drafted by AI, reviewed and approved by a human before it sends.",
              },
              {
                icon: Target,
                title: "Signal-triggered outreach",
                desc: "13+ buying signals (funding, hiring, champion job change) trigger perfectly-timed outreach.",
              },
              ...
              <div key={title} className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <div style={{ fontFamily: SANS, fontSize: 13, color: C.muted, lineHeight: 1.55 }}>
                    {desc}
                  </div>
                </div>
              </div>
...
function SlideHowItWorks() {
  const steps = [
    ...
    {
      n: "02",
      title: "Graph is built",
      desc: "Every teammate's connections form a unified graph. Edge weights encode warmth: meeting history, email cadence, shared history.",
    },
    {
      n: "03",
    ...
    {
      n: "04",
      title: "AI drafts, human approves",
      desc: "Personalized messages for each channel. A human reviews in the approval queue, then sends with one click.",
    },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          From cold contact to warm intro
          <br />
          in under 5 minutes
        </h2>
          ...
          {steps.map((s, i) => (
            <div key={s.n} className="relative">
              ...
              <div
                ...
                style={{ backgroundColor: C.canvas, border: `1px solid ${C.hairline}` }}
              >
                <div
                  style={{
                    fontFamily: SERIF,
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          A $12B market that's
          <br />
          never had a relationship-first solution
        </h2>
          ...
          {[
            {
              label: "TAM",
              value: "$12.4B",
              sub: "Sales Engagement + AI SDR platform market (2025)",
              color: C.primary,
            },
            {
              label: "SAM",
              value: "$3.1B",
              sub: "B2B SaaS companies, 10-1000 sales reps, US + EU",
              color: C.amber,
            },
            {
              label: "SOM",
              value: "$310M",
              sub: "SMB / mid-market segment, Year 3 target",
              color: C.teal,
            },
          ].map((m) => (
            <div
            ...
            >
              <div className="text-xs font-bold tracking-[0.15em] mb-3" style={{ color: m.color }}>
                {m.label}
              </div>
              <div
                style={{
        ...
        <div
          ...
          style={{ backgroundColor: C.soft, border: `1px solid ${C.hairline}` }}
        >
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
                  ...
                  {[
                    ...
                    <g key={i}>
                      <line
                        ...
                        x2={x as number}
                        y2={y as number}
                        stroke={i < 3 ? (col as string) : "#3d3d3a"}
              ...
              preview: (
                <div style={{ fontFamily: SANS }}>
                  {[
                    ...
                    <div
                      key={l.name}
                      className="flex items-center justify-between mb-2 rounded-lg px-3 py-2"
                      style={{ backgroundColor: "#1f1e1b" }}
                    >
                      <div>
                        <div style={{ fontSize: 10, color: C.onDark, fontWeight: 600 }}>
                          {l.name}
                        </div>
                      ...
                      <div
                        ...
                        style={{ backgroundColor: `${C.amber}22`, color: C.amber, fontSize: 9 }}
                      >
                        {l.score}
                      </div>
                    </div>
            ...
            >
              ...
              <div style={{ fontSize: 11, color: C.onDarkSoft, lineHeight: 1.5, marginBottom: 14 }}>
                {p.desc}
              </div>
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-3 gap-5 mb-8">
          {plans.map((p) => (
            ...
            >
              <div className="text-xs font-bold tracking-[0.15em] mb-4" style={{ color: p.color }}>
                {p.name.toUpperCase()}
              </div>
              <div className="flex items-end gap-1 mb-6">
                <span
                  style={{
                    ...
                    fontSize: 40,
                    fontWeight: 400,
                    color: p.highlight ? C.onDark : C.ink,
                    lineHeight: 1,
                  }}
                >
                  {p.price}
                ...
                <span
                  style={{
                    fontFamily: SANS,
                    fontSize: 12,
                    color: p.highlight ? C.onDarkSoft : C.muted,
                    paddingBottom: 6,
                  }}
                >
                  {p.per}
          ...
          {[
            {
              ...
              stat: "~82% gross margin",
              sub: "AI costs pass-through above threshold",
            },
            {
              icon: TrendingUp,
              label: "Growth model",
              stat: "Land & expand",
              sub: "Start with 1 AE, grow to team-wide",
            },
            {
              icon: Users,
              label: "Target customer",
              stat: "10–500 seat sales teams",
              sub: "B2B SaaS, fintech, professional services",
            },
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontFamily: SANS, fontWeight: 600, fontSize: 14, color: C.ink }}>
                  {stat}
                </div>
...
function SlideCompetition() {
  const rows = [
    ...
    {
      feature: "13+ buying signal types",
      wp: true,
      apollo: "partial",
      clay: "partial",
      artisan: "partial",
  ...
  function Cell({ v }: { v: boolean | string }) {
    ...
    if (v === false)
      return (
        <div className="flex justify-center">
          <span style={{ color: "#3d3d3a", fontSize: 14 }}>—</span>
        </div>
      );
    return (
      <div className="flex justify-center">
        <div
          className="h-5 w-5 rounded-full flex items-center justify-center"
          style={{ backgroundColor: `${C.amber}22` }}
        >
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          The only tool built around
          <br />
          <span style={{ color: C.primary }}>relationship-first outreach</span>
        </h2>
            ...
            <thead>
              <tr style={{ backgroundColor: C.darkElevated }}>
                <th
                  ...
                  style={{ fontFamily: SANS, fontSize: 11, color: C.onDarkSoft, fontWeight: 500 }}
                >
                  Feature
                </th>
                {[
                  ...
                  <th
                    ...
                    style={{
                      ...
                      color: h.highlight ? C.primary : C.onDarkSoft,
                      textAlign: "center",
                    }}
                  >
                    {h.name}
            ...
            <tbody>
              {rows.map((r, i) => (
                <tr
                  key={r.feature}
                  style={{
                    backgroundColor: i % 2 === 0 ? "#1c1b18" : C.dark,
                    borderTop: `1px solid #ffffff06`,
                  }}
                >
                  <td
                    className="px-5 py-3"
                    style={{ fontFamily: SANS, fontSize: 12, color: C.onDarkSoft }}
                  >
                    {r.feature}
                  </td>
                  <td className="px-4 py-3" style={{ backgroundColor: `${C.primary}08` }}>
                    <Cell v={r.wp} />
                  </td>
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-8">
            ...
            {[
              {
                ...
                desc: "Next.js 15 + FastAPI + PostgreSQL on Neon, deployed on Vercel + Railway",
                done: true,
              },
              {
                label: "AI intelligence layer",
                desc: "Signal scoring, BFS path ranking, multi-channel message generation with Anthropic",
                done: true,
              },
              {
                label: "Neon Postgres live",
                desc: "Seeded with demo workspace, accounts, contacts, warm paths, and campaigns",
                done: true,
              },
              {
                label: "Public deployments",
                desc: "Frontend on Vercel, intelligence service on Railway — accessible to anyone",
                done: true,
              },
              {
                label: "Beta pilot conversations",
                desc: "Outreach started to first 5 target customers in B2B SaaS",
                done: false,
              },
              {
                label: "Seed round",
                desc: "Targeting ₹1.5Cr seed to hire 2 engineers and run first paid pilots",
                done: false,
              },
            ].map((item) => (
              <div key={item.label} className="flex gap-3 items-start">
                <div
                  ...
                  style={{
                    backgroundColor: item.done ? `${C.teal}22` : `${C.muted}22`,
                    border: `1.5px solid ${item.done ? C.teal : C.muted}`,
                  }}
                >
                  {item.done ? (
          ...
          <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={t.layer} className="rounded-lg p-3" style={{ backgroundColor: C.soft }}>
                    <div
                      style={{ fontFamily: SANS, fontSize: 10, color: C.muted, marginBottom: 2 }}
                    >
                      {t.layer}
                    </div>
                    <div style={{ fontFamily: SANS, fontSize: 11, fontWeight: 600, color: C.ink }}>
                      {t.tech}
                    </div>
                  </div>
                ))}
            ...
            <div
              className="rounded-2xl p-6"
              style={{ backgroundColor: C.primary, border: `1px solid ${C.primary}` }}
            >
              <div
                style={{
                  fontFamily: SANS,
              ...
              >
                Full product, real data, no signup needed
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        >
          Built at BITS Pilani by
          <br />
          founders who've felt the pain
        </h2>
        ...
        <div className="grid grid-cols-3 gap-6 mb-10">
          {[
            ...
            >
              ...
              <div
                className="text-xs font-medium mb-4 px-2 py-1 rounded-full inline-block"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div style={{ fontFamily: SANS, fontSize: 13, color: C.muted, lineHeight: 1.6 }}>
              We watched senior sales leaders at BITS alumni companies close deals in weeks while
              junior reps flailed for months — the difference was always relationships, never
              effort.
            </div>
          </div>
          <div
          ...
          >
            ...
            <div style={{ fontFamily: SANS, fontSize: 13, color: C.muted, lineHeight: 1.6 }}>
              Connected to the BITS Pilani entrepreneur network — 10,000+ alumni in founder and
              executive roles across India and Silicon Valley.
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-3xl">
        <p
          className="text-xs font-semibold tracking-[0.2em] mb-6 uppercase"
          style={{ color: C.primary }}
        >
          The Ask
        </p>
        ...
        >
          Seed round to go
          <br />
          from 0 to first <span style={{ color: C.primary }}>$1M ARR</span>
        </h2>
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {[
            ...
            >
              ...
              <div style={{ fontFamily: SANS, fontSize: 11, color: C.onDarkSoft, lineHeight: 1.5 }}>
                {a.label}
              </div>
            </div>
          ))}
        ...
        <div
          ...
          style={{ backgroundColor: C.darkElevated, border: `1px solid #ffffff0d` }}
        >
          <div style={{ fontFamily: SANS, fontSize: 12, color: C.onDarkSoft, marginBottom: 12 }}>
            USE OF FUNDS
          </div>
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <div key={u.use}>
                <div style={{ fontFamily: SERIF, fontSize: 28, color: C.primary, marginBottom: 4 }}>
                  {u.pct}
                </div>
                <div
                  style={{ fontFamily: SANS, fontSize: 11, color: C.onDarkSoft, lineHeight: 1.5 }}
                >
                  {u.use}
                </div>
              </div>
          ...
          <span
            ...
            style={{
              color:
                ...
                SLIDES[current].id === "ask" ||
                SLIDES[current].id === "competition" ||
                SLIDES[current].id === "product"
                  ? C.onDark
                  : C.ink,
            }}
          >
      ...
      {current === 0 && (
        <div className="absolute bottom-16 left-0 right-0 flex justify-center z-20 pointer-events-none">
          <div
            ...
            style={{ backgroundColor: "rgba(255,255,255,0.08)", color: C.onDarkSoft }}
          >
