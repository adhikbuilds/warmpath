...
interface SequenceStep {
  ...
  subject_b?: string;
  day_b?: number;
  split?: number; // percentage routed to variant A (default 50)
}
                        ...
                        <div className="flex-1 min-w-0 space-y-1.5">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            <span className="text-muted-foreground text-[10px] px-1.5 py-0.5 rounded bg-muted border border-border/40">
                              Day {seqStep.day}
                              {seqStep.ab_enabled && seqStep.day_b != null
                                ? ` / ${seqStep.day_b}`
                                : ""}
                            </span>
                            ...
                            <button
                              ...
                              title="Run two variants and split traffic"
                            >
                              A/B
                            </button>
                          </div>
                          ...
                          {seqStep.ab_enabled && (
                            <div className="space-y-1.5 mt-1 p-2 rounded-md border border-blue-500/20 bg-blue-500/5">
                              ...
                              <div className="grid grid-cols-2 gap-1.5">
                                <input
                                  ...
                                  value={seqStep.subject_a ?? ""}
                                  onChange={(e) =>
                                    setConfig((c) => ({
                                      ...c,
                                      sequence: c.sequence.map((s) =>
                                        s.id === seqStep.id
                                          ? { ...s, subject_a: e.target.value }
                                          : s,
                                      ),
                                    }))
                                  }
                                  className="text-[11px] px-2 py-1 rounded border border-border/60 bg-background outline-none focus:border-blue-500/40"
                                />
                                <input
                                  type="text"
                                  placeholder="Subject B"
                                  value={seqStep.subject_b ?? ""}
                                  onChange={(e) =>
                                    setConfig((c) => ({
                                      ...c,
                                      sequence: c.sequence.map((s) =>
                                        s.id === seqStep.id
                                          ? { ...s, subject_b: e.target.value }
                                          : s,
                                      ),
                                    }))
                                  }
                              ...
                              <div className="flex items-center gap-2">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) =>
                                      setConfig((c) => ({
                                        ...
                                        sequence: c.sequence.map((s) =>
                                          s.id === seqStep.id
                                            ? { ...s, day: Math.max(0, +e.target.value) }
                                            : s,
                                        ),
                                      }))
                                    }
                                    className="w-12 text-[11px] px-1.5 py-0.5 rounded border border-border/60 bg-background outline-none focus:border-blue-500/40"
                                  />
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <input
                                    type="number"
                                    min={0}
                                    value={seqStep.day_b ?? 0}
                                    onChange={(e) =>
                                      setConfig((c) => ({
                                        ...c,
                                        sequence: c.sequence.map((s) =>
                                          s.id === seqStep.id
                                            ? { ...s, day_b: Math.max(0, +e.target.value) }
                                            : s,
                                        ),
                                      }))
                                    }
                                      ...
                                      setConfig((c) => ({
                                        ...
                                        sequence: c.sequence.map((s) =>
                                          s.id === seqStep.id
                                            ? {
                                                ...s,
                                                split: Math.min(99, Math.max(1, +e.target.value)),
                                              }
                                            : s,
                                        ),
                                      }))
                ...
                <table className="w-full text-xs">
                  ...
                  <tbody>
                    {displayAccounts.map((account) => {
                      const hasWarmBlue = warmPaths.some((wp) => wp.account_id === account.id);
                        ...
                        >
                          ...
                          <td className="px-4 py-2.5">
                            <div className="flex items-center gap-1 flex-wrap">
                              ...
                              {!hasWarmBlue && accountSignals.length === 0 && (
